...
urlpatterns = [
    ...
    path('pokemon/<int:pokemon>/update/', views.PokemonUpdate.as_view(), name='pokemon_update'),
    path('pokemon/<int:pokemon>/delete/', views.PokemonDelete.as_view(), name='pokemon_delete'),
]
